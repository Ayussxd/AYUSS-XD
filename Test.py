...
def contact():
	...
	os.system('xdg-open https://www.facebook.com/profile.php?id=100076644619404')
...
\033[1;32m----------------------------------------------
➤➤⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃ AYUSS⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃➤➤
❣︎[𖣘]☔︎CREATED BY   :  AYUSS_XD
❣︎[𖣘]☔︎ FB NAME     : AAYUSH CHHETRI
❣︎[𖣘]☔︎ON GITHUB    :  AYUSS
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r {P}[AYUSS]{P} {P}{loop}{P}/{P}{len(id)}{P} OK{P}[{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
